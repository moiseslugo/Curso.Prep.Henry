...
function arrayContiene(array, elemento) {
  ...
  for ( var i = 0; i<array.length; i++){
        ...
        return false; //cuando queremos retrnar false despues que se haya cumplido el bucle, este debe colocarse fuera del bucle
...
function breakStatement(numero) {
 ...
 tomar en cuenta  que no vamso a necesitar el array.length, luego debemos tener cuidado de como fucnciona
 el break statementem este  va a salri del ciclo for donde le esperan dos nuevas condicione, la primera es 
