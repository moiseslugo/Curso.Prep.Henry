...
  // Si no se pasan argumentos devuelve 0. Si se pasa un argumento, simplemente devuélvelo
  ...
  if ( arguments.length<1){return 0};//clausula "si no se pasa argumento"
  var multiplicacion =1;// sea cre esta variable porque el primero numero del array se debe multiplicar por 1
  for (var i = 0; i< arguments.length; i++){
    multiplicacion = multiplicacion*arguments[i];
  }//Se crea un loop for para recorrer el array. Comienza por el primer subindice y terminando en longitud menos 1 
  return multiplicacion; //Devuelve la variable multiplicación
}
...
for ( var i = 0; i<arreglo.length; i++){
 ...
 //Si esto es cierto se suman las veces que el loop dio mayor a 18.
 }
return retorno;
//Se retorna el valor sumado en la variable retorno.
}
